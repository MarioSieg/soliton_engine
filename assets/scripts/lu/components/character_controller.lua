...
CHARACTER_GROUND_STATE = { -- Keep in sync with C++: CharacterBase.h 
    ...
    NOT_SUPPORTED = 3, -- Character is touching an object, but is not supported by it and should fall. The GetGroundXXX functions will return information about the touched object.
    IN_AIR = 4 -- Character is in the air and is not touching anything.
}
