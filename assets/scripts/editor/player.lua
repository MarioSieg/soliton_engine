...
function player:_update_camera()
    ...
    local rot = quat.from_yaw_pitch_roll(self._mouse_angles.x, self._mouse_angles.y, 0.0)

    if self._movement_state ~= movement_state.idle and self.enable_view_bob then
