...
void EmscriptenDisplay::Show()
{
    ...
    emscripten_set_resize_callback(0, this, false,
#else
    ...
    emscripten_set_focusin_callback("#canvas", this, true,
    [](int, const EmscriptenFocusEvent*, void* user) -> EMSCRIPTEN_RESULT
    {
        EmscriptenDisplay* display = (EmscriptenDisplay*)user;
    ...
    emscripten_set_focusout_callback("#canvas", this, true,
    [](int, const EmscriptenFocusEvent*, void* user) -> EMSCRIPTEN_RESULT
    {
        EmscriptenDisplay* display = (EmscriptenDisplay*)user;
    ...
    emscripten_set_keydown_callback("#canvas", this, true, 
    ...
    emscripten_set_keyup_callback("#canvas", this, true, 
    [](int, const EmscriptenKeyboardEvent* e, void* user) -> EMSCRIPTEN_RESULT
    {
        if (e->keyCode <= 0xff)
        {
    ...
    emscripten_set_keypress_callback("#canvas", this, true,
    [](int, const EmscriptenKeyboardEvent* e, void* user) -> EMSCRIPTEN_RESULT
    {
        EmscriptenDisplay* display = (EmscriptenDisplay*)user;
