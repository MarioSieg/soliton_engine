...
namespace engine
{
	...
	void cmdCopyAccelerationStructure(
		VkCommandBuffer commandBuffer, 
	...
	void cmdWriteAccelerationStructuresProperties(
		VkCommandBuffer commandBuffer, 
	...
	void cmdSetPolygonFillMode(VkCommandBuffer commandBuffer, VkPolygonMode polygonMode)
	{
		// No all driver support this feature.
	#if 0
		static auto ptr = (PFN_vkCmdSetPolygonModeEXT) vkGetDeviceProcAddr(getContext()->getDevice(), "vkCmdSetPolygonModeEXT");
		return ptr(commandBuffer, polygonMode);
	#endif 
	}
}