...
namespace scripting {
    ...
    public:
        ...
        [[nodiscard]] auto operator ()() -> T {
            register_var();
            return m_ref ? m_ref->cast<T>().valueOr(fallback()) : fallback();
        }
    ...
    private:
        auto register_var() {
            ...
            log_info("Registering convar #{} [{} : {}] | {:#x}", ++s_convar_i, full_name(), type_name(), m_flags);
        ...
        std::stack<luabridge::LuaRef> m_refs {};
