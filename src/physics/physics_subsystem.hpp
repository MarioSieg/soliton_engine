...
namespace physics {
    ...
    private:
        ...
        static inline const std::uint32_t k_num_threads = std::max(std::thread::hardware_concurrency() / 4, 2u);
        ...
        std::unique_ptr<JPH::BodyActivationListener> m_body_activation_listener {};
