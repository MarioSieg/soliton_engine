...
namespace lu {
    ...
    public:
        ...
        auto get() const noexcept -> eastl::span<const eastl::pair<spdlog::level::level_enum, eastl::string>> {
            return m_Backtrace;
        }
    ...
    private:
        eastl::vector<eastl::pair<spdlog::level::level_enum, eastl::string>> m_Backtrace{};
        ...
        auto sink_it_(const spdlog::details::log_msg& msg) -> void override {
            ...
            m_Backtrace.emplace_back(eastl::make_pair(msg.level, std::move(message)));
        }
